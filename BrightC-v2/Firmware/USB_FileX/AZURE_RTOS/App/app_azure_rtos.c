...
static UCHAR tx_byte_pool_buffer[TX_APP_MEM_POOL_SIZE] CCMRAM_LOCATE;
static TX_BYTE_POOL tx_app_byte_pool;

/* USER CODE BEGIN FX_Pool_Buffer */
/* USER CODE END FX_Pool_Buffer */
static UCHAR  fx_byte_pool_buffer[FX_APP_MEM_POOL_SIZE] CCMRAM_LOCATE;
...
static UCHAR  ux_host_byte_pool_buffer[UX_HOST_APP_MEM_POOL_SIZE] CCMRAM_LOCATE;
