...
const App = function({}) {
  ...
  if (!user) return html`<${Login} loginFn=${login} logoIcon=${Logo} title="BrightC Login" tipText="To login, use: admin/admin, user1/user1, user2/user2" />`; // If not logged in, show login screen
